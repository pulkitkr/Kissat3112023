...
public class RingUserDetailPage {
	...
	//First Name
			...
			public static By objFirstName=By.xpath("//*[@class='android.view.ViewGroup' and ./*[@class='android.view.ViewGroup'] and ./*[@text='First Name']]");	
			
			//Last Name
			public static By objLastName = By.xpath("//*[@text='Last Name']/parent::android.view.ViewGroup");
			//public static By objLastName=By.xpath("//*[@id='text-input-outlined' and (./preceding-sibling::* | ./following-sibling::*)[./*[@text='Last Name']]]");
			...
			//public static By objMothersName=By.xpath("//*[@id='text-input-outlined' and (./preceding-sibling::* | ./following-sibling::*)[./*[@text=concat('Mother', \"'\", 's Name')]]]");		
			//Email
